...
defmodule EasyCampaignWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: EasyCampaignWeb.Coherence.EmailView, layout: {EasyCampaignWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
